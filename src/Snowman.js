...
function Snowman({
  ...
  const lossMessage = `You lose. The correct word is: ${answer}`;
  ...
  /** If the game in progress: show buttons.
   *  If win: show win message
   *  If loss: show loss message
   */
  ...
  return (
    <div className="Snowman">
      ...
      <p id='button-area'>{showButtonsOrWinLossMessage()}</p>
